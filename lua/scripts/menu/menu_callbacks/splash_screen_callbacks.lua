...
function SplashScreenCallbacks:cb_open_url_in_steam_overlay(url)
	Steam.open_url(url)
end

function SplashScreenCallbacks:cb_pdx_login_popup_enter(args)
	self._state:cb_pdx_login_popup_enter(args)
end

function SplashScreenCallbacks:cb_pdx_login_popup_item_selected(args)
	self._state:cb_pdx_login_popup_item_selected(args)
end

function SplashScreenCallbacks:cb_pdx_account_login_button_disabled(args)
	return self._state:cb_pdx_account_login_button_disabled(args)
end
