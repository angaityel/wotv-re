...
function TextBoxMenuContainer:render(dt, t, gui, layout_settings)
	if self._text then
		...
		if layout_settings.background_rect then
			...
			Gui.rect(gui, Vector3(math.floor(self._x - layout_settings.background_rect_offset), math.floor(self._y + y_offset + layout_settings.background_rect_offset), self._z - 2), Vector2(layout_settings.background_size[1] + layout_settings.background_rect_offset * 2, -layout_settings.background_size[2] - layout_settings.background_rect_offset * 2), color)
		end
	end
end
