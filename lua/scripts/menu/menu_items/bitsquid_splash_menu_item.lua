...
function BitsquidSplashMenuItem:init(config, world)
	...
	self._splash = BitsquidSplash.create("overlay", "rendering/mercury_default", true)
end
...
function BitsquidSplashMenuItem:on_page_enter()
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
	local music_event = layout_settings.music_event or self.config.music_event or nil
