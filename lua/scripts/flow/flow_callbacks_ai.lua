...
function flow_callback_change_ai_behaviour(params)
	local spawner_unit = params.spawner_unit
	local spawner = ScriptUnit.extension(spawner_unit, "spawner_system")

	spawner:change_behaviour(params.behaviour_name)
end

function flow_callback_set_ai_invulnerable(params)
	local spawner_unit = params.spawner_unit
	local spawner = ScriptUnit.extension(spawner_unit, "spawner_system")

	spawner:set_ai_invulnerable()
end

function flow_callback_set_ai_vulnerable(params)
	local spawner_unit = params.spawner_unit
	local spawner = ScriptUnit.extension(spawner_unit, "spawner_system")

	spawner:set_ai_vulnerable()
end
