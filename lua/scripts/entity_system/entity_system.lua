...
require("scripts/entity_system/systems/range_culling/range_culling_system")
...
require("scripts/unit_extensions/projectiles/thrown_projectile")
...
function EntitySystem:_init_systems()
	...
	self:_add_system("range_culling_system", RangeCullingSystem, system_context, true)
end
