...
function HorseDamage:network_recieve_add_custom_damage_over_time(...)
	self:add_damage_over_time(...)
end
...
function HorseDamage:network_recieve_add_damage(attacker_player, attacker_unit, damage_type, damage, position, normal, damage_range_type, gear_name, attack_name, hit_zone, impact_direction, real_damage, range, mirrored)
	self:add_damage(attacker_player, attacker_unit, damage_type, damage, position, normal, nil, damage_range_type, gear_name, attack_name, hit_zone, impact_direction, real_damage, range, mirrored)
end

function HorseDamage:add_damage(attacker_player, attacker_unit, damage_type, damage, position, normal, actor, damage_range_type, gear_name, attack_name, hit_zone, impact_direction, real_damage, range, mirrored)
