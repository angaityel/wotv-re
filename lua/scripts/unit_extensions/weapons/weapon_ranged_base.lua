...
function WeaponRangedBase:init(world, unit, user_unit, player, id, user_locomotion)
	self._world = world
	self._unit = unit
	...
	self._projectile_name = user_locomotion:has_perk("flaming_arrows") and "fire" or "default"
	self._settings = Gear[self._gear_name]
	self._projectile_settings = self._settings.projectiles[self._projectile_name]
...
function WeaponRangedBase:zoom_camera_node()
	return self._settings.zoom_camera_node
end
...
function WeaponRangedBase:can_throw()
	return false
end
...
function WeaponRangedBase:release_projectile(slot_name)
	self._loaded = false
end
...
function WeaponRangedBase:set_sheathed(sheathed)
	return
end
...
function WeaponRangedBase:player_dead()
	return
end
