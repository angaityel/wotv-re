...
function WeaponCrossbowBase:init(world, unit, user_unit, player, id, user_locomotion)
	WeaponCrossbowBase.super.init(self, world, unit, user_unit, player, id, user_locomotion)
