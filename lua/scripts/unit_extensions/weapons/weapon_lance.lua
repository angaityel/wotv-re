...
WeaponLance = class(WeaponLance, WeaponMelee)

function WeaponLance:init(world, unit, user_unit, player, id, user_locomotion)
	WeaponLance.super.init(self, world, unit, user_unit, player, id, user_locomotion)
