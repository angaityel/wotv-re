...
function ExecutionHelper.pick_execution(attacker_unit, victim_unit, wielded_slots)
	...
	local one_handed_slot = wielded_slots.secondary
	local two_handed_slot = wielded_slots.primary
...
function PlayerExecuting:init(unit, internal, world)
	PlayerExecuting.super.init(self, unit, internal, world)
...
function PlayerExecuting:_update_position(dt, t)
	...
	self:_set_execution_pose(self._target_unit, ExecutionDefinitions[self._execution], dt, t)
	self._rotation_component:update(dt, t)
end

function PlayerExecuting:_set_execution_pose(victim_unit, execution_definition, dt, t)
