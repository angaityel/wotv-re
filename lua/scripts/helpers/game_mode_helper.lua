...
function GameModeHelper:announcement_parameters(announcement, player, world, in_param_1, in_param_2)
	local param1_func = Announcements[announcement].param1
	local param2_func = Announcements[announcement].param2
	local param1 = param1_func and GameModeHelper[param1_func](self, player, world) or in_param_1
	local param2 = param2_func and GameModeHelper[param2_func](self, player, world) or in_param_2
...
function GameModeHelper:last_objective_enemy_ui_name(player)
	local team_name = player.team.name == "red" and "white" or "red"
	local objective_units = Managers.state.game_mode:not_owned_objectives(team_name)
