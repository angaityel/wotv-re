...
local IsUnlockOwned = {
	...
	head = function(unlock)
		return check_unlock(Heads, unlock.name)
	end,
	...
	helmet_variation = function(unlock)
		return check_unlock(HelmetVariations, unlock.name)
	end,
	helmet_attachment = function(unlock)
		return check_unlock_attachment(unlock.attachment)
	end,
	perk = function(unlock)
		return check_unlock(PerkUnlocks, unlock.name)
	end,
	...
	beard = function(unlock)
		return check_unlock(BeardNames, unlock.name)
	end,
	beard_color = function(unlock)
		return check_unlock(BeardColorNames, unlock.name)
	end,
	taunt = function(unlock)
		return check_unlock(PlayerUnitMovementSettings.taunts, unlock.name)
	end,
	cloak = function(unlock)
		return check_unlock(Cloaks, unlock.name)
	end,
	cloak_pattern = function(unlock)
		return check_unlock(CloakPatterns, unlock.name)
	end,
	armour_pattern = function(unlock)
		return check_unlock(ArmourPatterns, unlock.name)
	end
}
