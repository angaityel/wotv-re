...
function HUDTextBuffElement:render(dt, t, gui, layout_settings)
	...
	local font = layout_settings.font and layout_settings.font.font or MenuSettings.fonts.wotr_hud_text_36.font
	local font_material = layout_settings.font and layout_settings.font.material
