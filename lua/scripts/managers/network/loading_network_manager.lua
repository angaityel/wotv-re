...
function LoadingNetworkManager:rpc_load_next_level(sender, level_key, game_mode_key, game_start_countdown, win_score, time_limit)
	self._state.parent.permission_to_enter_game = false
...
function LoadingNetworkManager:rpc_admin_chat_message(sender, channel_id, message_sender, message)
	Managers.state.event:trigger("event_admin_chat_message", channel_id, message_sender, message)
end

function LoadingNetworkManager:rpc_rcon_chat_message(sender, channel_id, message_sender, message)
