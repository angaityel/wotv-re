...
function MenuNetworkManager:rpc_admin_chat_message(sender, channel_id, message_sender, message)
	Managers.state.event:trigger("event_admin_chat_message", channel_id, message_sender, message)
end

function MenuNetworkManager:rpc_rcon_chat_message(sender, channel_id, message_sender, message)
